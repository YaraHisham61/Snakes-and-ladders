...
public:
	bool overlapping(GameObject* pNewObject);
	...
	bool getcellobject(CellPosition cposition);
	bool getcellsnakeorladder(CellPosition cposition);
	...
	Card* GetCard(const CellPosition& position);
