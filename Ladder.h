...
public:
	...
	/*bool risingladder(CellPosition& startCellPos, CellPosition& endCellPos);
	bool verticalladder(CellPosition& startCellPos, CellPosition& endCellPos);
	bool validstartladdercell(CellPosition& startCellPos);*/
	bool overlappingladder(GameObject* Obj);
